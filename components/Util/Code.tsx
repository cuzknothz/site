  ...
  return (
    <Fragment>
      <div className='relative' ref={codeContainer}>
        <div className='flex h-[40px] w-full items-center justify-between rounded-t-[6px] border-[1px] border-b-[0px] border-[#00000085] bg-[#383838] px-[15px] dark:border-[#07cdff]'>
          <div>
            <svg
        ...
        <div
          ref={codeBlockRef}
          className='dsalkjf kljkl duration-500 [&>pre]:rounded-b-[6px] [&>pre]:!border-[1px] [&>pre]:!border-[#00000085] [&>pre]:!p-[16px] [&>pre]:whitespace-break-spaces [&>pre]:dark:!border-[#07cdff]'
