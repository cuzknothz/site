                ...
                {i.role === 'user' ? (
                  ...
                  <div className='flex w-full justify-start pr-10 hover:pr-0'>
                    <Box className='inline justify-end border-0! bg-transparent py-2.5'>
                      {i.content && (
                        <div className='flex w-full flex-col gap-2 overflow-hidden [&_a]:text-blue-500 [&_a]:underline [&_blockquote]:border-l-4 [&_blockquote]:border-gray-500 [&_blockquote]:pl-2 [&_code]:rounded [&_code]:bg-[#e0e0e0] [&_code]:px-1 [&_code]:text-[#d21616] dark:[&_code]:bg-[#333] dark:[&_code]:text-[#ff4d4d] [&_h1]:text-2xl [&_h1]:font-bold [&_h2]:text-xl [&_h2]:font-bold [&_h3]:text-lg [&_h3]:font-bold [&_ol]:ml-4 [&_ol]:list-decimal [&_pre]:overflow-x-auto [&_pre]:rounded [&_pre]:bg-[#e0e0e0] [&_pre]:p-2 dark:[&_pre]:bg-[#333] [&_pre_code]:bg-transparent [&_pre_code]:text-black dark:[&_pre_code]:text-white [&_table]:w-full [&_table]:border-collapse [&_table]:border-gray-200 [&_td]:border [&_td]:border-gray-200 [&_td]:p-2 [&_th]:border [&_th]:border-gray-200 [&_th]:bg-gray-100 [&_th]:p-2 dark:[&_th]:bg-gray-800 [&_ul]:ml-4 [&_ul]:list-disc'>
